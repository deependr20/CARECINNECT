  ...
  return (
    <div className='bg-[#5F6FFF] rounded-lg my-16 md:min-h-auto min-h-[45vh]  lg:mx-0 md:px-16 px-5 pt-4 items-center  flex justify-between'>
            <div className='w-[70%]'> 
                    ...
                    <button to={"/login"} className=' text-slate-500 font-medium hover:scale-110 transition-all duration-500 bg-white md:px-8  md:py-3 px-4 py-2 rounded-full'>Create account</button>
            </div>
